...
Partial Public Class DatabaseDataSet
    ...
    Partial Public Class DepartmentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddDepartmentRow(ByVal Department As String, ByVal Dean As String, ByVal Description As String, ByVal Sem As String, ByVal School_Year As String) As DepartmentRow
            Dim rowDepartmentRow As DepartmentRow = CType(Me.NewRow,DepartmentRow)
            Dim columnValuesArray() As Object = New Object() {Department, Dean, Description, Sem, School_Year}
    ...
    Partial Public Class DepartmentRow
        ...
        Public Property Sem() As String
            Get
                Try 
                    Return CType(Me(Me.tableDepartment.SemColumn),String)
                Catch e As Global.System.InvalidCastException
        ...
        Public Property School_Year() As String
            Get
                Try 
                    Return CType(Me(Me.tableDepartment.School_YearColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'School_Year' in table 'Department' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableDepartment.School_YearColumn) = value
            End Set
        End Property
        ...
        Public Function IsSchool_YearNull() As Boolean
            Return Me.IsNull(Me.tableDepartment.School_YearColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetSchool_YearNull()
            Me(Me.tableDepartment.School_YearColumn) = Global.System.Convert.DBNull
        End Sub
    ...
    Partial Public Class DepartmentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Department` WHERE ((`Department` = ?) AND ((? = 1 AND `Dean` IS NULL"& _ 
                ...
                ") AND ((? = 1 AND `Sem` IS NULL) OR (`Sem` = ?)) AND ((? = 1 AND `School_Year` I"& _ 
                "S NULL) OR (`School_Year` = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Department", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Department", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Department` (`Department`, `Dean`, `Description`, `Sem`, `School_Yea"& _ 
                "r`) VALUES (?, ?, ?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Department", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Department", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Department` SET `Department` = ?, `Dean` = ?, `Description` = ?, `Sem` = "& _ 
                "?, `School_Year` = ? WHERE ((`Department` = ?) AND ((? = 1 AND `Dean` IS NULL) O"& _ 
                "R (`Dean` = ?)) AND ((? = 1 AND `Description` IS NULL) OR (`Description` = ?)) A"& _ 
                "ND ((? = 1 AND `Sem` IS NULL) OR (`Sem` = ?)) AND ((? = 1 AND `School_Year` IS N"& _ 
                "ULL) OR (`School_Year` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Department", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Department", Global.System.Data.DataRowVersion.Current, false, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT Department, Dean, Description, Sem, School_Year FROM Department"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As DatabaseDataSet.DepartmentDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As DatabaseDataSet.DepartmentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DatabaseDataSet.DepartmentDataTable = New DatabaseDataSet.DepartmentDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DatabaseDataSet.DepartmentDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_Department As String, ByVal Original_Dean As String, ByVal Original_Description As String, ByVal Original_Sem As String, ByVal Original_School_Year As String) As Integer
            If (Original_Department Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_School_Year,String)
            End If
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.DeleteCommand.Connection.State
            If ((Me.Adapter.DeleteCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal Department As String, ByVal Dean As String, ByVal Description As String, ByVal Sem As String, ByVal School_Year As String) As Integer
            If (Department Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
            ...
            If (Sem Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(3).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(3).Value = CType(Sem,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Department As String, ByVal Dean As String, ByVal Description As String, ByVal Sem As String, ByVal School_Year As String, ByVal Original_Department As String, ByVal Original_Dean As String, ByVal Original_Description As String, ByVal Original_Sem As String, ByVal Original_School_Year As String) As Integer
            If (Department Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
            ...
            If (Sem Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Sem,String)
            End If
            If (School_Year Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = Global.System.DBNull.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_Dean,String)
            End If
            If (Original_Description Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_School_Year,String)
            End If
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
            If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Dean As String, ByVal Description As String, ByVal Sem As String, ByVal School_Year As String, ByVal Original_Department As String, ByVal Original_Dean As String, ByVal Original_Description As String, ByVal Original_Sem As String, ByVal Original_School_Year As String) As Integer
            Return Me.Update(Original_Department, Dean, Description, Sem, School_Year, Original_Department, Original_Dean, Original_Description, Original_Sem, Original_School_Year)
        End Function
    End Class
